    ...
    <section id="gallery" className="py-24 bg-muted/30">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <p className="text-sm uppercase tracking-[0.2em] text-primary mb-4">Cultural Heritage</p>
          <h2 className="font-serif text-4xl md:text-5xl font-medium text-foreground mb-4">Regional Gallery</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                <h3 className="font-serif text-4xl font-medium">{currentRegion.name}</h3>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">{currentRegion.story}</p>

              <div>
                <h4 className="font-medium text-foreground mb-3">Featured Crafts</h4>
                <div className="flex flex-wrap gap-2">
                  {currentRegion.crafts.map((craft) => (
                    <span key={craft} className="px-4 py-2 bg-primary/10 text-primary rounded-full text-sm">
                      {craft}
                    </span>
                  ))}
                </div>
                ...
                {regions.map((region, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all ${
                      index === activeRegion ? "bg-primary w-8" : "bg-border hover:bg-primary/50"
                    }`}
                  />
                ))}
              </div>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-secondary/90 via-secondary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  ...
                  <p className="text-sm text-white/70">{item.region}</p>
                </div>
              </div>
            </div>
          ))}
